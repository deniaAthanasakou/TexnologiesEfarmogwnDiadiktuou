Πληροφορίες ομάδας
	...
	•	Στεφανία Πάτσου με ΑΜ: 1115201400156 και
...
Σχόλια/Παρατηρήσεις
	...
	•	Κατά την λειτουργία των Servlets, κάποια τρέχουν χωρίς πρόβλημα ενώ άλλα τρέχουν και ορισμένες φορές όχι. 
